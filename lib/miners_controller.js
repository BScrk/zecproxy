...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
MinersController.prototype.sendToMiner = function (id,obj) {
    logger.dbg('[MINER<'+id+'>:SEND] ',obj);
    if(this.miners.get(id)){
        this.miners.get(id).send(obj);        
    }else{
        logger.dbg('[MINER<'+id+'>] Offine');        
    }
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
MinersController.prototype.removeMiner = function (id) {
    this.miners.delete(this.id);
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Miner.prototype.onEnd = function() {
    ...
    logger.dbg('[MINER<'+this.id+'>:DISCONNECTED] ', this.id);
